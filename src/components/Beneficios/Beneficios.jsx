    ...
    <section id="benefinicios" className="section">
      ...
      <div className="container__beneficios">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Mapa interactivo</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Tickets</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Fallas para todas las edades</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Gamificacion</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Tradición digitalizada</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Todo bajo control</h3>
          <p className="benefits__body">
        ...
        <div className="">
          ...
          <h3 className="benefits__title">Difusión en un clic</h3>
          <p className="benefits__body">
