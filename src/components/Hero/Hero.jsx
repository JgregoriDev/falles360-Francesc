  ...
  return (
    <section className="section__hero">
      ...
      <div className="Hero__container--buttons mt-2 mb-">
        <a
          className="button container__pricing-element--outline text__notunderline" href=""
        >
          <svg height={50} width={50} className="icon__button--red " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
      ...
      <div className="Hero__container--buttons mt-2 mb-2">
        <a
          className="button button button-primary text__notunderline "
          target="_blank"
          href="#"
        >
          <svg
        ...
        <a
          className="button button-primary text__notunderline "
          target="_blank"
          href="#"
        >
          <svg
