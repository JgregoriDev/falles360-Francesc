...
export const Hero = () => {
    const [num, setNum] = useState({'360':360,'user':7500, 'fallas':70,'eventos':35,'tickets':10550});
  useEffect(() => {
  ...
  return (
    <section className="section__hero">
      <div className="Hero__container">
        <div className="Hero__container--titles">
          <h1 className="Hero__text">
            <span  className="Hero__text--gradient">Falles <span style={{'--num': num[360]}} className="span ger"></span> </span>
      ...
      <div className="hero__container--stats pb-3">
        <p>
          Número de fallas: <span style={{'--num': num.fallas}} className="text--bolder span"></span>
        </p>
        <p>
          Número de eventos: <span style={{'--num': num.eventos}} className="text--bolder span"></span>
        </p>
        <p>
          Usuarios registrados: <span style={{'--num': num.user}} className="text--bolder span"></span>
        </p>
        <p>
          Tiquets comprados: <span style={{'--num': num.tickets}} className="text--bolder span"></span>
        </p>
      </div>
    </section>
  );
